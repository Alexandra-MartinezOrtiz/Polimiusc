...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="songs-title">Listado de canciones</div>

            <asp:GridView ID="gridViewSongs" runat="server" AutoGenerateColumns="False" CssClass="table">
                <Columns>
                    <asp:BoundField DataField="ID_SONG" HeaderText="ID_SONG" />
                    <asp:BoundField DataField="SONG_NAME" HeaderText="SONG_NAME" />
                    <asp:BoundField DataField="SONG_PATH" HeaderText="SONG_PATH" />
                    <asp:BoundField DataField="PLAYS" HeaderText="PLAYS" />

                   <asp:TemplateField HeaderText="Reproducir">
              <ItemTemplate>
                <audio controls style="width: 200px;">
                    <source src='<%# ResolveUrl("~/songFiles/" + System.IO.Path.GetFileName(Eval("SONG_PATH").ToString())) %>' type="audio/mpeg" />
