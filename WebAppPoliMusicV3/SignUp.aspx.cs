...
namespace WebAppPoliMusicV3
{
    public partial class SignUp : System.Web.UI.Page
    {
        ...
        protected void btnSumbit_Click(object sender, EventArgs e)
        {
            ...
            {
                DateTime d;
                if (DateTime.TryParseExact(txtBirthDate.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out d))
                {
        ...
        {
            if (string.IsNullOrEmpty(email) || email.Replace(" ", "") == string.Empty)
                return false;
        ...
        private static string NormalizeEmailDomain(string email)
        {
            ...
            return match.Groups[1].Value + asciiDomain;
        }
    }
}
